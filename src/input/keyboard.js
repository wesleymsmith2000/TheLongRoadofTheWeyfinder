  ...
  return {
    ...
    read() {
      ...
      const snapshot = {
        ...
        targetCellCycle: actionPressed(pressed, controlBindings.targetCellPrevious) ? -1 : actionPressed(pressed, controlBindings.targetCellNext) ? 1 : 0,
...
function preventedKeys(bindings) {
  return new Set([
    ...
    ...bindings.targetPrevious,
    ...bindings.targetNext,
    ...bindings.targetCellPrevious,
    ...bindings.targetCellNext,
