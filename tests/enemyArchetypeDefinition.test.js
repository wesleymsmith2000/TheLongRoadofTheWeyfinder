...
test('enemy archetype helpers expose editor-facing enemy models', () => {
  ...
  assert.equal(getEnemyArchetype('scrap_buzzard.shadowed_desert').presentation.sprite.assetId, 'sprite.enemy.scrap_buzzard');
  ...
  assert.equal(getEnemyArchetype('inchworm_carrier.freedoms_pass').presentation.sprite.assetId, 'sprite.enemy.inchworm_carrier');
