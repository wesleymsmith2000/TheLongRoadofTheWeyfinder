...
The weapon examples include Tracking Flechette, STA Missile, and Orb Of Blades JSON using the current runtime fields for orthogonal delayed launch, live-reticle homing/arc tracking, contrails, emitted blade sprites, and blade projectile absorption.
